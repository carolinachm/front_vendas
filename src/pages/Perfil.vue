        ...
        <v-card>
          ...
          <v-card-text>
            <v-container grid-list-xl>
              <v-layout wrap row>
                <v-flex xs12>
                  <v-select :items="clientes" label="Selecione o cliente" v-model="perfil.cliente" item-text="cpf" return-object>
                  </v-select>
                </v-flex>
...
<template slot="items" slot-scope="props">
  <td class="text-xs-center">
    ...
    {{ props.item.cliente.cpf}}</td>
  <td class="text-xs-center">{{ props.item.atendimento.nome}}</td>
  <td class="text-xs-center">{{ props.item.acessorio.descricao}}</td>
